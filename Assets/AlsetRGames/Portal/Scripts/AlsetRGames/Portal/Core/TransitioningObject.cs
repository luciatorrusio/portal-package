...
namespace AlsetRGames.Portal.Core
{
    public class TransitioningObject 
    {
        ...
        private readonly TransitionListener _objectTransitionListener;
        [CanBeNull] public TransitionListener inPortalListener { get; private set; }
        [CanBeNull] public TransitionListener outPortalListener { get; private set; }
        ...
        public TransitioningObject(Transform original,Transform clone, Portal portalIn, Portal portalOut,IEnumerable<( Transform original, Transform clone)> originalToCloneList,  TransitionListener transitionListener)
        {
            _original = original;
            ...
            _objectTransitionListener = transitionListener;
            inPortalListener = portalIn.GetComponent<TransitionListener>();
            outPortalListener = portalOut.GetComponent<TransitionListener>();
        ...
        {
            return _objectTransitionListener;
        }
        ...
        public void SwitchPortals(Portal portalIn, Portal portalOut)
        {
            ...
            _portalIn = portalIn;
            _portalOut = portalOut;
            (inPortalListener, outPortalListener) = (outPortalListener, inPortalListener);
